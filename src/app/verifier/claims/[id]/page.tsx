              ...
              {claim.publications?.[0] && (
                <div className="space-y-3 pt-3 border-t border-border/40">
                  <div>
                    ...
                    <span className="font-semibold text-primary">{claim.publications[0].title}</span>
                  </div>
                  <div>
                    <span className="text-xs text-muted-foreground block">Journal Name</span>
                    <span>{claim.publications[0].journal_name}</span>
                  </div>
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <span className="text-xs text-muted-foreground block">Indexing</span>
                      <span className="font-medium">{claim.publications[0].indexing || "N/A"}</span>
                    </div>
                    <div>
                      <span className="text-xs text-muted-foreground block">Quartile</span>
                      <span className="font-medium">{claim.publications[0].quartile || "N/A"}</span>
                    </div>
                    <div>
                      <span className="text-xs text-muted-foreground block">Impact Factor</span>
                      <span className="font-medium">{claim.publications[0].impact_factor || "N/A"}</span>
                    </div>
                  </div>
                </div>
              )}
