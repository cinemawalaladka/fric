...
export function StepBookChapter({ details, onUpdate }: Props) {
  return (
    <div className="animate-slide-up">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Provide details about the chapter published in a book.
      </p>
      ...
      <Card className="glass-card border-border/40">
        <CardContent className="pt-6 space-y-5">
          <div className="space-y-2">
            ...
            <Input
              placeholder="Enter the title of your book chapter"
              value={details.chapterTitle || ""}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={details.chapterNumber || ""}
                onChange={(e) => onUpdate("chapterNumber", e.target.value)}
                className="bg-input/50 border-border/50"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="e.g., 45–68"
                value={details.pageRange || ""}
      ...
      <div className="mt-4 p-3 rounded-lg bg-purple-500/5 border border-purple-500/15 text-xs text-purple-400">
        💡 International Publisher: ₹5,000 &nbsp;|&nbsp; National Publisher: ₹2,000 (subject to ISBN proof)
      </div>
    </div>
  );
}
